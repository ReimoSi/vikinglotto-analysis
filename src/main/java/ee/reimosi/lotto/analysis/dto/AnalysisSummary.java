...
public class AnalysisSummary {
    ...
    public int getMainPerDraw() {
        return mainPerDraw;
    }

    public void setMainPerDraw(int mainPerDraw) {
        this.mainPerDraw = mainPerDraw;
    }

    public long getTotalMainPicks() {
        return totalMainPicks;
    }

    public void setTotalMainPicks(long totalMainPicks) {
        this.totalMainPicks = totalMainPicks;
    }
    ...
    public List<Count> getMainFrequencies() {
        return mainFrequencies;
    }

    public void setMainFrequencies(List<Count> mainFrequencies) {
        this.mainFrequencies = mainFrequencies;
    }

    public List<Count> getBonusFrequencies() {
        return bonusFrequencies;
    }

    public void setBonusFrequencies(List<Count> bonusFrequencies) {
        this.bonusFrequencies = bonusFrequencies;
    }
}
